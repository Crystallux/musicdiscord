...
class Economy:
    ...
    async def register(self, ctx):
        """Registers an account at the Brooklyn bank"""
        ...
        try:
            ...
            await self.bot.say("{} You already have an account at the"
                               " Brooklyn bank.".format(author.mention))
        ...
        if not user:
            ...
            try:
                ...
                await self.bot.say("{} You don't have an account at the"
                                   " Brooklyn bank. Type `{}bank register`"
    ...
    async def _set(self, ctx, user: discord.Member, credits: SetParser):
        ...
        Examples:
            bank set @Young 26 - Sets 26 credits
            bank set @Young +2 - Adds 2 credits
            bank set @Young -6 - Removes 6 credits"""
        author = ctx.message.author
        try:
